...
function PostDetails() {
  ...
  const [comments, setComments]=useState([
      {
          comment: "hello11fdklasjfklasjdklfjskldjskdlfjldksjlkdjsldjfklsdjfklsdjklsjflkfsflkdajdsjklsjdsjfdjlsdjfsljflkslksfksdlksdjflksdjkdfjksdjflkdjklsddjafdkjs1",
          username: "testuser"
      },
      {
        comment: "hello111",
